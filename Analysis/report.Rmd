...
enrollment <- read.csv('../../data/enroll_interns_2016-2018_20190304.csv', stringsAsFactors = F)
#pharm <- read.csv('../../data/claims_pharm_capstone_2016-2018.csv', stringsAsFactors = F)

#join enrollment with med to get all HCAs
med_enrollment <- med %>% right_join(enrollment)
...
```{r echo=FALSE} 
age_dist <- med_enrollment %>% 
  group_by(Age) %>% 
  summarise(count = n())
age_dist <- age_dist[!(age_dist$Age==255),]
...
diabetes_age_percentage <- right_join(diabetes_age, age_dist, by= "Age")
diabetes_age_percentage$count.x[is.na(diabetes_age_percentage$count.x)] <- 0
diabetes_age_percentage <- mutate(diabetes_age_percentage, percentage = count.x/count.y)
diabetes_age_percentage <- filter(diabetes_age_percentage, !is.na(Primary.ICD.Rollup))
...
hypertension_age_percentage <- right_join(hypertension_age, age_dist, by= "Age")
hypertension_age_percentage$count.x[is.na(hypertension_age_percentage$count.x)] <- 0
hypertension_age_percentage <- mutate(hypertension_age_percentage, percentage = count.x/count.y)
...
cancer_age_percentage <- right_join(cancer_age, age_dist, by= "Age")
cancer_age_percentage$count.x[is.na(cancer_age_percentage$count.x)] <- 0
cancer_age_percentage <- mutate(cancer_age_percentage, percentage = count.x/count.y)
cancer_age_percentage <- filter(cancer_age_percentage, !is.na(Primary.ICD.Rollup))
...
obesity_age_percentage <- right_join(obesity_age, age_dist, by= "Age")
obesity_age_percentage$count.x[is.na(obesity_age_percentage$count.x)] <- 0
obesity_age_percentage <- mutate(obesity_age_percentage, percentage = count.x/count.y)
